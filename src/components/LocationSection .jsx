        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className=" p-6 rounded-lg shadow-md h-full">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2 text-red-700">Our Location</h3>
                <p className="text-gray-100 text-lg">77/81 Reserve Rd,</p>
                <p className="text-gray-100 text-lg">Artarmon NSW 2064</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-xl mb-2 text-red-700">Contact Us</h3>
                <p className="text-gray-100 text-lg">(02) 9438 4988</p>
                <p className="text-gray-100 text-lg">sparklingcarcare1@gmail.com</p>
              </div>
            </div>
          </div>
